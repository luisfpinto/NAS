...
sed -i "250s/   read only = yes/read only = no/" /etc/samba/smb.conf
...
sed -i '59aunix extensions = no' /etc/samba/smb.conf
...
sed -i "17s#/var/run/usbmount/\$name#/home/shares/public/\$name#" /etc/usbmount/umount.d/00_remove_model_symlink
sed -i "18s#/var/run/usbmount/\$name#/home/shares/public/\$name#" /etc/usbmount/umount.d/00_remove_model_symlink
sed -i '19d' /etc/usbmount/umount.d/00_remove_model_symlink
#Restarting server
